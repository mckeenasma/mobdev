        ...
        <ScrollView>
            ...
            <View style={styles.tempNavigators}>
                <View style={{padding: 20, paddingLeft: 0, alignSelf: 'center', flexDirection: "row", justifyContent: "space-between"}}>
                    <FontAwesome name={'facebook'} style={{color: colors.white}} size={22} />
                    <Text style={{color: colors.white, paddingLeft: '10%', fontWeight: 'bold'}}>Login with Facebook</Text>
                </View>
            </View>
            ...
            {/* Header */}
                ...
                <Text style={{padding: 20, justifyContent: 'center', textAlign: 'center'}}>Your public profile, friend list, email address and birthday.</Text>
      ...
      />
            ...
            <View style={{paddingTop: '30%'}}>
                <View style={{padding: 20, paddingLeft: 0, alignSelf: 'center', flexDirection: "row", justifyContent: "space-between"}}>
                    ...
                    <Text style={{color: colors.black, paddingLeft: '5%', fontWeight: 'bold'}}>This doesn’t let the app post to Facebook.</Text>
                </View>
            </View>
